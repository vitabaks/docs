...
export default function About() {
  ...
  return (
    <section className={styles.aboutSection}>
      ...
      <p className={styles.description}>
        PostgreSQL is an outstanding database; however, unlike commercial DBMS solutions, it doesn’t include built-in tools for high availability, graphical monitoring, or a UI management interface commonly found in commercial offerings.
      ...
      <p className={styles.description}>
        To bridge this gap, the <a href="https://github.com/vitabaks/postgresql_cluster" target="_blank" rel="noopener noreferrer">postgresql_cluster</a> automation toolkit was developed in 2019, was initially developed for personal use, then opened to the community.
