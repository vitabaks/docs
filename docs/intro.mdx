...
docker run -d --name autobase-console \
  ...
  autobase/console:2.7.1
```

Alternatively, you can use [Docker Compose](https://github.com/autobase-tech/autobase/blob/2.7.1/console/docker-compose.yml).
...
:::info
Alternatively, you can use [Ansible Collection](https://github.com/autobase-tech/autobase/blob/2.7.1/automation/README.md)
:::
