...
docker run -d --name autobase-console \
  ...
  autobase/console:2.6.0
```

Alternatively, you can use [Docker Compose](https://github.com/autobase-tech/autobase/blob/2.6.0/console/docker-compose.yml).
...
:::info
Alternatively, you can use [Ansible Collection](https://github.com/autobase-tech/autobase/blob/2.6.0/automation/README.md)
:::
