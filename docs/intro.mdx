...
docker run -d --name autobase-console \
  ...
  --volume dbdesk_studio_data:/opt/dbdesk-studio \
  --volume /var/run/docker.sock:/var/run/docker.sock \
  --volume /tmp/ansible:/tmp/ansible \
  --restart=unless-stopped \
  autobase/console:2.7.0
```

Alternatively, you can use [Docker Compose](https://github.com/autobase-tech/autobase/blob/2.7.0/console/docker-compose.yml).
...
:::info
Alternatively, you can use [Ansible Collection](https://github.com/autobase-tech/autobase/blob/2.7.0/automation/README.md)
:::
