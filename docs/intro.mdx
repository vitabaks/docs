...
Alternatively, you can use [Docker Compose](https://github.com/vitabaks/autobase/blob/2.6.0/console/docker-compose.yml).
...
:::info
Alternatively, you can use [Ansible Collection](https://github.com/vitabaks/autobase/blob/2.6.0/automation/README.md)
:::
