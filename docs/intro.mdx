...
docker run -d --name autobase-console \
  ...
  autobase/console:2.5.1
```

Alternatively, you can use [Docker Compose](https://github.com/vitabaks/autobase/blob/2.5.1/console/docker-compose.yml).
...
:::info
Alternatively, you can use [Ansible Collection](https://github.com/vitabaks/autobase/blob/2.5.1/automation/README.md)
:::
