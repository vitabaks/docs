...
**[Autobase](https://github.com/autobase-tech/autobase)** will automatically set up the following in Google Cloud:
...
<Tabs defaultValue="console-ui">
  ...
  <TabItem value="console-ui" label="Console (UI)">
    ...
    {/* ===== INTERNAL TAB: Expert ===== */}
      <TabItem value="expert" label="Expert Mode">
        ...
        Make sure it follows the format supported by the Google Cloud API (e.g., `n4-standard-8`).
        :::

        <ThemedImage
          alt="instance-type"
          sources={{
            light: '/img/instance-type-gcp.expert-mode.png',
            dark: '/img/instance-type-gcp.expert-mode.dark.png',
          }}
        />
        ...
        **Spot instances** can be used if needed.
        ...
        <ThemedImage
          alt="data-disk-storage"
          sources={{
            light: '/img/data-disk-storage-gcp.expert-mode.png',
            dark: '/img/data-disk-storage-gcp.expert-mode.dark.png',
          }}
        />

        If needed, specify the Network name to which the database servers will be added. If not specified, the default network is used.
        ...
        :::info
        By default, Autobase automatically configures these parameters. See the default settings for [Postgres](https://github.com/autobase-tech/autobase/blob/2.10.0/automation/roles/common/defaults/main.yml#L331) and the [kernel](https://github.com/autobase-tech/autobase/blob/2.10.0/automation/roles/common/defaults/main.yml#L889). \
        If you prefer to set the parameters manually, click **Configure** button and specify them in the usual key=value format.
        :::
    ...
    {/* ===== INTERNAL TAB: YAML ===== */}
      <TabItem value="yaml" label="YAML tab">
        ...
        <ThemedImage
          alt="cluster"
          sources={{
            light: '/img/yaml-tab-gcp.png',
            dark: '/img/yaml-tab-gcp.dark.png',
          }}
        />

        Autobase offers a wide range of functionality, and not all options can be fully represented in UI forms. That’s why we added a YAML editor — it allows you to set any parameters supported by Autobase. You can see available parameters [here](https://github.com/autobase-tech/autobase/blob/2.10.0/automation/roles/cloud_resources/defaults/main.yml) (for cloud resources) and [here](https://github.com/autobase-tech/autobase/blob/2.10.0/automation/roles/common/defaults/main.yml) (for cluster settings).
  ...
  :::note
  See the [default](https://github.com/autobase-tech/autobase/tree/2.10.0/automation/roles/common/defaults/main.yml) automation variables for more details, including the list of available [variables](https://github.com/autobase-tech/autobase/blob/2.10.0/automation/roles/cloud_resources/defaults/main.yml) for cloud resources.
  :::
