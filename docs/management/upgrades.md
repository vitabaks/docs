...
The variable file is located on the path: [roles/update/defaults/main.yml](https://github.com/vitabaks/autobase/blob/2.4.1/automation/roles/update/defaults/main.yml)
...
The variable file is located on the path: [roles/upgrade/defaults/main.yml](https://github.com/vitabaks/autobase/blob/2.4.1/automation/roles/upgrade/defaults/main.yml)
