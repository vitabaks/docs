...
image: autobase/automation:2.5.2
...
:::info
- **group_vars/all.yml**: Configuration variables — refer to the [default](https://github.com/vitabaks/autobase/blob/2.5.2/automation/roles/common/defaults/main.yml) values. Override them as needed using group_vars, host_vars, or directly in the inventory file.
