...
:::warning
When the vip-manager service is stopped, the VIP address is [removed](https://github.com/autobase-tech/autobase/blob/2.6.0/automation/roles/vip-manager/templates/vip-manager.service.j2#L12). It will be re-added when the service starts again, provided that the current server is the leader.
:::
