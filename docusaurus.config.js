...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        content:
          '<span class="announcement-system">[ SYSTEM UPDATE ]</span> <a target="_blank" rel="noopener noreferrer" href="https://github.com/autobase-tech/autobase/releases/tag/2.11.0">Autobase 2.11 released -&gt;</a>',
